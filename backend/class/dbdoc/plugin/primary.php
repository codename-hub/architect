 ...
 * @package architect
 */
abstract class primary extends modelPrefix
{
    /**
     * [EXCEPTION_DBDOC_PLUGIN_PRIMARY_GETDEFINITION_MISSING description]
     * @var string
     */
    public const EXCEPTION_DBDOC_PLUGIN_PRIMARY_GETDEFINITION_MISSING = "EXCEPTION_DBDOC_PLUGIN_PRIMARY_GETDEFINITION_MISSING";

    /**
     * [EXCEPTION_DBDOC_PLUGIN_PRIMARY_GETDEFINITION_MULTIPLE description]
     * @var string
     */
    public const EXCEPTION_DBDOC_PLUGIN_PRIMARY_GETDEFINITION_MULTIPLE = "EXCEPTION_DBDOC_PLUGIN_PRIMARY_GETDEFINITION_MULTIPLE";
